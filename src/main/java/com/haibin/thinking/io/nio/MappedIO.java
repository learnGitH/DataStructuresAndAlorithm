...
public class MappedIO {
    ...
    private static final String FILE_NAME = IOFileBaseName.baseName + "nio\\temp.tmp";
    ...
    private static Tester[] tests = {
        new Tester("Stream Write"){
            ...
            new Tester("Stream read"){
                public void test() throws IOException{
                    DataInputStream dis = new DataInputStream(new BufferedInputStream(new FileInputStream(new File(FILE_NAME))));
                    for (int i = 0; i < numOfInts; i++){
                        dis.readInt();
                    }
                    dis.close();
            ...
            new Tester("Stream Read/Write"){
                public void test() throws IOException{
                    RandomAccessFile raf = new RandomAccessFile(new File(FILE_NAME),"rw");
                    raf.writeInt(1);
